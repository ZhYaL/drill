...
<html lang="en">
  <head>
    ...
    <title>迷你服务器，个人博客，你值得拥有666</title>
        ...
        <div class="row justify-content-md-center">
          <div class="col-md-10">
            <div class="contents text-center">
              <h1 class="wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="0.3s">termux帮助你搭建个人服务器</h1>
              <p class="lead  wow fadeIn" data-wow-duration="1000ms" data-wow-delay="400ms">年华你好
              </p>
              <a href="#" class="btn btn-common wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="400ms">Download博客</a>
            </div>
          </div>
        </div> 
      </div>           
